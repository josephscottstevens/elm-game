...
var _user$project$Functions$displayRes = function (t) {
	return _elm_lang$core$Basics$toString(
		_elm_lang$core$Basics$floor(t));
};

var _user$project$Main$loadingFunction = function (t) {
	return (_elm_lang$core$Native_Utils.cmp(t, 100.0) > -1) ? 100.0 : t;
};
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {resources: a, mdl: b, exploreProgress: c, exploreSpeed: d};
	});
var _user$project$Main$Health = {ctor: 'Health'};
var _user$project$Main$Energy = {ctor: 'Energy'};
var _user$project$Main$Water = {ctor: 'Water'};
var _user$project$Main$Food = {ctor: 'Food'};
		...
		switch (_p0.ctor) {
			case 'Tick':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{exploreProgress: model.exploreProgress + model.exploreSpeed}),
					{ctor: '[]'});
			case 'Increase':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'grid-template-columns', _1: '1fr 1fr 1fr'},
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('explore'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Progress$progress(
										_user$project$Main$loadingFunction(model.exploreProgress)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$millisecond * 1000, _user$project$Main$Tick);
};
